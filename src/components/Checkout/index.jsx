...
import { FaShippingFast, FaStore, FaCreditCard } from "react-icons/fa";

const Checkout = () => {
    const products = [
        { id: 1, name: "3D Attractive Pot", price: 90.0, quantity: 1, image: "/accesories.jpg" },
        { id: 2, name: "Cluse La Boheme Rose Gold", price: 45.0, quantity: 1, image: "/Gold01.jpg", details: "Green / XS" },
        { id: 3, name: "Men pants", price: 56.0, quantity: 1, image: "/Gold02.jpg", details: "Blue" },
    ];
                ...
                <div className={styles.leftSection}>
                    <div className={styles.container}>
                        ...
                        <div className={styles.footerLinks}>
                            ...
                            <a href="#">Terms of service</a> | <a href="#">Contact information</a>
                        </div>
                    </div>
                </div>
                ...
                <div className={styles.rightSection}>
                    ...
                    <div className={styles.summaryBox}>
                        ...
                        <div className={styles.totalBox}>
                            <span>Total</span>
                            <span><span className={styles.currency}>USD</span> ${subtotal.toFixed(2)}</span>
                        </div>
                    </div>
                </div>
            </div>
